...
final class PaymentListBuilder {
    ...
    static func make() -> PaymentListViewController {
        let storyboard = UIStoryboard(name: "PaymentList", bundle: nil)
        let view = storyboard.instantiateViewController(withIdentifier: "PaymentListViewController") as! PaymentListViewController
        // TODO: Injections
